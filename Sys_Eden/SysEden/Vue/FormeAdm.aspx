<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormeAdm.aspx.cs" Inherits="PLATFORMMEDICAL.Vue.FormeAdm" %>
                            ...
                            <div class="sub-section col-md-12 col-lg-8">
                                ...
                                <div class="sub-section-body">
                                    <div class="user-details-form">
                                        <div class="form-row">
                                            <div class="form-group col-sm-6" style="left: 0px; top: 0px">
                                                <label>Code Utilisateur<br />
                                                <asp:TextBox ID="txtcode" class="form-control" runat="server" Enabled="False" EnableTheming="True"></asp:TextBox>
                                                <br />
                                                </label>
                                                &nbsp;</div>
                                      ...
                                      <div class="form-group col-sm-6">
                                           <asp:Button ID="btnEnregistrer" CssClass="btn btn-dark-red-f-gr mt-4" runat="server" Text="Enregistrer" OnClick="btnEnregistrer_Click" />
                                         &nbsp;
                                            <asp:Button ID="btnAnnuler" CssClass="btn btn-dark-red-f-gr mt-4" runat="server" Text="Annuler" OnClick="btnAnnuler_Click" />
